...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('rss_scraper_post', (
            ('uri', self.gf('django.db.models.fields.CharField')(max_length=1200, primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=10002)),
            ('opt', self.gf('django.db.models.fields.CharField')(max_length=10002)),
    ...
    models = {
        ...
        'rss_scraper.post': {
            ...
            'opt': ('django.db.models.fields.CharField', [], {'max_length': '10002'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '10002'}),
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '1200', 'primary_key': 'True'})
        },
        'rss_scraper.user': {
